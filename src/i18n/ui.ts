...
export const ui = {
  en: {
    ...
    'home.disciplines.filming.title': 'Videography',
    ...
    'contact.intro':
      "Have a project in mind, or just want to say hi? My inbox is open — I try to reply within 24h.",
    ...
    'contact.form.projectTypes.editing': 'Photo Editing',
    'contact.form.projectTypes.videoediting': 'Video Editing',
    'contact.form.projectTypes.stopmotion': 'Stop Motion',
    'contact.form.projectTypes.2danimation': '2D animation',
  ...
  pt: {
    ...
    'home.disciplines.filming.title': 'Videografia',
    ...
    'contact.intro':
      'Tem um projeto em mente, ou só quer dizer olá? A minha caixa de correio está aberta — costumo responder em 24h.',
    ...
    'contact.form.projectTypes.stopmotion': 'Stop Motion',
    'contact.form.projectTypes.2danimation': 'Animação 2D',
